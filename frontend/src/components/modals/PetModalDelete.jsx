  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-full sm:w-[500px] mx-4 z-20">
        <h2 className="text-lg font-bold font-secundary text-[20px] text-[#595146] mb-4 text-center">
        ...
        <div className="font-raleway text-[16px] text-[#595146] font-bold flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-4 mt-6">
          <button
            onClick={onClose}
            className="w-[200px] sm:w-[200px] md:w-[227px] px-4 py-2 bg-white rounded-lg hover:bg-gray-400 border-b-4 border-2 border-gray-400"
          >
            Cancelar
          </button>
          <button
