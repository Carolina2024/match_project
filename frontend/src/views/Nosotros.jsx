...
const Nosotros = () => {
  return (
    <main className="w-full bg-[#F9F9F9] flex flex-col justify-center items-center rounded-t-[50px] pb-20 ">
      ...
      {/* Nuestra historia */}
      <div className="w-full max-w-5xl px-8 py-8 md:py-12  border-1 border-primary rounded-[50px] mt-12 mx-auto">
      ...
      <div className="w-full max-w-6xl px-6 py-8">
        <div className="bg-[#F9F9F9] rounded-[30px] md:rounded-[50px] px-6 md:px-24 py-6 border border-primary">
