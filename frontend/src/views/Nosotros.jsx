...
const Nosotros = () => {
  return (
    <main className="md:max-w-6xl max-w-lg mx-20 bg-[#F9F9F9] flex flex-col justify-center items-center rounded-t-[50px]">
      {/* Imagen encabezado */}
      <div className="relative w-full md:max-w-6xl max-w-lg">
        <img
          src={nosotros}
          alt="Gato acariciado"
          className="w-full h-[500px]  object-cover rounded-t-[50px]"
        />
      </div>

      {/* Nuestra historia */}
      <div className="max-w-4xl  border-1 border-primary rounded-[50px] mt-12 mx-auto py-8 px-4">
      ...
      <div className="max-w-4xl justify-center mx-auto px-4 py-8 relative">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <p>
                ...
                <span className="font-bold  text-[#595146] text-xl">
                  mascotas rescatadas
                </span>
              </p>
            </div>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <p>
                <span className="text-4xl font-bold text-primary">230</span>{" "}
                <span className="font-bold  text-[#595146] text-xl">
                  mascotas adoptadas
                </span>
              </p>
      ...
      <div className="bg-white rounded-lg border-[#DFDFDF] mt-24 border-1 p-6 text-center">
      ...
      <div className="mx-14">
        <p className="font-medium text-xl text-[#000000] p-20 text-justify">
      ...
      <div className="max-w-6xl mt-2 py-8">
        <div className="bg-[#F9F9F9] rounded-[50px] mx-16 px-24 py-6 border-1   border-primary">
      ...
      <div className=" ">
        {" "}
        {/* Contenedor padre */}
        <div className="grid md:grid-cols-2 gap-4 bg-[#FFFFFF] rounded-[50px] mx-16 px-24 py-6">
          {" "}
          {/* Caja de Misión */}
          <div className="p-4">
            {" "}
            {/* Añadí un padding para el contenido interno */}
          ...
          <div className="p-4">
            ...
            <p className="text-xl font-medium text-[#000000] mt-2">
              {" "}
              {/* Añadí un margen superior */}
              ° Amor y respeto por los seres vivos <br />
              ° Educación como motor de cambio <br />
              ° Solidaridad y compromiso social <br />
              ° Vida rural en armonía con la naturaleza <br />° Responsabilidad
              en la adopción y tenencia animal
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold font-secundary text-primary mt-38 text-center mb-8">
          ¿Cómo colaborar?
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 mt-12 gap-6">
            ...
            {/* Corazón Quiltro */}
            <div className="rounded-[50px] border-1 border-primary p-6 flex flex-col items-center">
              <div className="w-68 h-52 rounded-[50px] overflow-hidden mb-4 bg-gray-300 flex items-center justify-center">
                <img
                  src={nosotrosp3}
                  alt="Huella Fuerte"
                  className="w-full h-full object-cover"
        ...
        <div className="flex justify-center mt-30">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
            {/* Campañas */}
            <div className="rounded-[50px] border-1 border-primary bg-[#FFFFFF] py-6 px-2 flex flex-col items-center">
              ...
              <div className="w-62 h-50 rounded-[50px] overflow-hidden mb-4 bg-gray-100">
                <img
                  src={nosotrosg4}
